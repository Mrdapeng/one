...
router.get("/homeData", function (req, res) {
  ...
  http.get("http://m.wufazhuce.com/", function (response) {
    ...
    response.on('end', function () {
      ...
      homeQuestion.quTitle = $(".question .text-title").text()
...
router.get("/muscicDetail", function (req, res) {
  var aId = req.query.aId;
  var detail = {}
  var  _html;
  detail.editor = []
  http.get("http://m.wufuzhuce.com/music/" + aId, function (response) {
    response.on("data", function (chunk) {
      _html += chunk
    })
    response.on("end", function () {
